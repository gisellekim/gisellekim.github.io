		...
		/* #about1 image slide */
			...
			/* #ABOUT2 p 대체 */
				$('#about2 p').hover(function(){
					$('#about2 .about_eng').toggleClass('show');
					$('#about2 .about_kor').toggleClass('show');
				},function(){
					$('#about2 .about_eng').toggleClass('show');
					$('#about2 .about_kor').toggleClass('show');
				});
		  ...
		  if ($(window).width() > 1024) {
			...
			/* when it is narrower than 1024 */
				...
				/* work shortcut mobile */
						...
						wn[1] = $('#work1 ul li:nth-child(10)').offset().top;
						wn[2] = $('#work2 ul li:nth-child(10)').offset().top;
						wn[3] = $('#work3 ul li:nth-child(10)').offset().top;
						wn[4] = $('#work4 ul li:nth-child(10)').offset().top;
						wn[5] = $('#work5 ul li:nth-child(10)').offset().top;
